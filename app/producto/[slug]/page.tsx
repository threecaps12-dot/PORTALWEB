...
const PRODUCT = {
  ...
  description:
    "Gorra negra con ilustración bordada estilo grafiti, tipografía \"NY\" en relieve y acabado desgastado tipo tag. Pieza única inspirada en la cultura urbana de la calle.",
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-12 grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <div className="flex items-baseline gap-3 mb-2">
            <span className="text-2xl font-semibold text-obsidian dark:text-cream">${PRODUCT.price.toFixed(2)}</span>
            {PRODUCT.compareAtPrice && (
              <span className="text-obsidian/40 dark:text-cream/40 line-through">${PRODUCT.compareAtPrice.toFixed(2)}</span>
            )}
          </div>
          ...
          <p className="text-obsidian/70 dark:text-cream/70 text-sm leading-relaxed mb-8">{PRODUCT.description}</p>
